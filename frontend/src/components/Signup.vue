<script setup>
import { ref } from 'vue'
import { signup } from "../assets/API.js"
...
/**
 * Submits HTML registration form. Loads values from the corresponding form fields
 * and sends signup request to API.
 */
...
<template>
    <form class="form-control-lg">
        ...
        <div class="form-group text-end mt-3">
            <input class="btn btn-primary" type="button" value="Sign Up" @click="submit">
        </div>
    </form>
</template>